...
function ENT:Reload()--Simple missile launcher function
			...
			Amraam = ents.Create( "3m_54e1_kalibr_dumb" )-- Create missile
...
function ENT:ReloadGuided()
			AmraamG = ents.Create( "3m_54e1_kalibr_guided" )-- Create missile
			AmraamG:SetPos( self:GetPos() +Vector(0,0,300))
